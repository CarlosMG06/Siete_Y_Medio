esp48 = {
    "O01": {"literal": "As de Oros", "value": 1, "priority": 4, "realValue": 1}, #Oros
    ...
    "C01": {"literal": "As de Copas", "value": 1, "priority": 3, "realValue": 1}, #Copas
    ...
    "E01": {"literal": "As de Espadas", "value": 1, "priority": 2, "realValue": 1}, #Espadas
    ...
    "B01": {"literal": "As de Bastos", "value": 1, "priority": 1, "realValue": 1}, #Bastos
...
esp40 = {
    ...
    "O06": {"literal": "Seis de Oros", "value": 6, "priority": 4, "realValue": 6},
    "O07": {"literal": "Siete de Oros", "value": 7, "priority": 4, "realValue": 7},
    "O08": {"literal": "Sota de Oros", "value": 10, "priority": 4, "realValue": 0.5},
    "O09": {"literal": "Caballo de Oros", "value": 11, "priority": 4, "realValue": 0.5},
    "O10": {"literal": "Rey de Oros", "value": 12, "priority": 4, "realValue": 0.5},
    ...
    "C06": {"literal": "Seis de Copas", "value": 6, "priority": 3, "realValue": 6},
    "C07": {"literal": "Siete de Copas", "value": 7, "priority": 3, "realValue": 7},
    "C08": {"literal": "Sota de Copas", "value": 10, "priority": 3, "realValue": 0.5},
    "C09": {"literal": "Caballo de Copas", "value": 11, "priority": 3, "realValue": 0.5},
    "C10": {"literal": "Rey de Copas", "value": 12, "priority": 3, "realValue": 0.5},
    ...
    "E06": {"literal": "Seis de Espadas", "value": 6, "priority": 2, "realValue": 6},
    "E07": {"literal": "Siete de Espadas", "value": 7, "priority": 2, "realValue": 7},
    "E08": {"literal": "Sota de Espadas", "value": 10, "priority": 2, "realValue": 0.5},
    "E09": {"literal": "Caballo de Espadas", "value": 11, "priority": 2, "realValue": 0.5},
    "E10": {"literal": "Rey de Espadas", "value": 12, "priority": 2, "realValue": 0.5},
    ...
    "B06": {"literal": "Seis de Bastos", "value": 6, "priority": 1, "realValue": 6},
    "B07": {"literal": "Siete de Bastos", "value": 7, "priority": 1, "realValue": 7},
    "B08": {"literal": "Sota de Bastos", "value": 10, "priority": 1, "realValue": 0.5},
    "B09": {"literal": "Caballo de Bastos", "value": 11, "priority": 1, "realValue": 0.5},
    "B10": {"literal": "Rey de Bastos", "value": 12, "priority": 1, "realValue": 0.5},
}

poker = {
    "C01": {"literal": "As de Corazones", "value": 1, "priority": 4, "realValue": 1}, #Corazones
    ...
    "C11": {"literal": "Sota de Corazones", "value": 11, "priority": 4, "realValue": 0.5},
    ...
    "D01": {"literal": "As de Diamantes", "value": 1, "priority": 3, "realValue": 1}, #Diamantes
    "D02": {"literal": "Dos de Diamantes", "value": 2, "priority": 3, "realValue": 2},
    "D03": {"literal": "Tres de Diamantes", "value": 3, "priority": 3, "realValue": 3},
    "D04": {"literal": "Cuatro de Diamantes", "value": 4, "priority": 3, "realValue": 4},
    "D05": {"literal": "Cinco de Diamantes", "value": 5, "priority": 3, "realValue": 5},
    "D06": {"literal": "Seis de Diamantes", "value": 6, "priority": 3, "realValue": 6},
    "D07": {"literal": "Siete de Diamantes", "value": 7, "priority": 3, "realValue": 7},
    "D08": {"literal": "Ocho de Diamantes", "value": 8, "priority": 3, "realValue": 0.5},
    "D09": {"literal": "Nueve de Diamantes", "value": 9, "priority": 3, "realValue": 0.5},
    "D10": {"literal": "Diez de Diamantes", "value": 10, "priority": 3, "realValue": 0.5},
    "D11": {"literal": "Sota de Diamantes", "value": 11, "priority": 3, "realValue": 0.5},
    "D12": {"literal": "Reina de Diamantes", "value": 12, "priority": 3, "realValue": 0.5},
    "D13": {"literal": "Rey de Diamantes", "value": 13, "priority": 3, "realValue": 0.5},

    "T01": {"literal": "As de Treboles", "value": 1, "priority": 2, "realValue": 1}, #Tréboles
    ...
    "T11": {"literal": "Sota de Treboles", "value": 11, "priority": 2, "realValue": 0.5},
    "T12": {"literal": "Reina de Treboles", "value": 12, "priority": 2, "realValue": 0.5},
    "T13": {"literal": "Rey de Treboles", "value": 13, "priority": 2, "realValue": 0.5},

    "P01": {"literal": "As de Picas", "value": 1, "priority": 1, "realValue": 1}, #Picas
    "P02": {"literal": "Dos de Picas", "value": 2, "priority": 1, "realValue": 2},
    "P03": {"literal": "Tres de Picas", "value": 3, "priority": 1, "realValue": 3},
    "P04": {"literal": "Cuatro de Picas", "value": 4, "priority": 1, "realValue": 4},
    "P05": {"literal": "Cinco de Picas", "value": 5, "priority": 1, "realValue": 5},
    "P06": {"literal": "Seis de Picas", "value": 6, "priority": 1, "realValue": 6},
    "P07": {"literal": "Siete de Picas", "value": 7, "priority": 1, "realValue": 7},
    "P08": {"literal": "Ocho de Picas", "value": 8, "priority": 1, "realValue": 0.5},
    "P09": {"literal": "Nueve de Picas", "value": 9, "priority": 1, "realValue": 0.5},
    "P10": {"literal": "Diez de Picas", "value": 10, "priority": 1, "realValue": 0.5},
    "P11": {"literal": "Sota de Picas", "value": 11, "priority": 1, "realValue": 0.5},
    "P12": {"literal": "Reina de Picas", "value": 12, "priority": 1, "realValue": 0.5},
    "P13": {"literal": "Rey de Picas", "value": 13, "priority": 1, "realValue": 0.5}
